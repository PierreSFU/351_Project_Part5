 ...
 : ReceiverBaseState(name, parent, mgr)
{
	...
	mySubStates.push_back(new WorkaroundTransient1_CompleteReceiverTopLevel("WorkaroundTransient1_CompleteReceiverTopLevel", this, mgr));
	setType(eSuper);
}
...
void CompleteReceiverTopLevel_ReceiverSS::onCONTMessage(const Mesg& mesg)
{
	...
	ReceiverX& ctx = getMgr()->getCtx();
		...
		/* -g option specified while compilation. */
		myMgr->debugLog("CompleteReceiverTopLevel_ReceiverSS CONT <message trapped>");

	if(true)
	{
		/* -g option specified while compilation. */
		myMgr->debugLog("CompleteReceiverTopLevel_ReceiverSS CONT <executing exit>");

		const BaseState* root = getMgr()->executeExit("CompleteReceiverTopLevel_ReceiverSS", "FinalState");
		/* -g option specified while compilation. */
		myMgr->debugLog("CompleteReceiverTopLevel_ReceiverSS CONT <executing effect>");
		...
		/* -g option specified while compilation. */
		myMgr->debugLog("CompleteReceiverTopLevel_ReceiverSS CONT <executing entry>");
 ...
 : ReceiverBaseState(name, parent, mgr)
{
	...
	mySubStates.push_back(new WorkaroundTransient2_KBcancelable("WorkaroundTransient2_KBcancelable", this, mgr));
	setType(eSuper);
}
...
void KBcancelable_CompleteReceiverTopLevel::onTMMessage(const Mesg& mesg)
{
	...
	if(ctx.errCnt < errB && !ctx.KbCan)
	{
		...
		const BaseState* root = getMgr()->executeExit("KBcancelable_CompleteReceiverTopLevel", "WorkaroundTransient1_CompleteReceiverTopLevel");
		/* -g option specified while compilation. */
		...
		getMgr()->executeEntry(root, "WorkaroundTransient1_CompleteReceiverTopLevel");
		return;
	}
	else
	if(ctx.errCnt>=errB || ctx.KbCan)
...
void BETWEEN_KBcancelable::onSERMessage(const Mesg& mesg)
{
	...
	{
		/* -g option specified while compilation. */
		myMgr->debugLog("BETWEEN_KBcancelable SER <executing exit>");

		const BaseState* root = getMgr()->executeExit("BETWEEN_KBcancelable", "WorkaroundTransient2_KBcancelable");
		/* -g option specified while compilation. */
		...
		/* -g option specified while compilation. */
		myMgr->debugLog("BETWEEN_KBcancelable SER <executing entry>");

		getMgr()->executeEntry(root, "WorkaroundTransient2_KBcancelable");
		return;
	}
...
//--------------------------------------------------------------------
WorkaroundTransient2_KBcancelable::WorkaroundTransient2_KBcancelable(const string& name, BaseState* parent, ReceiverSS* mgr)
 : ReceiverBaseState(name, parent, mgr)
{
	myHistory = false;
}

void WorkaroundTransient2_KBcancelable::onEntry()
{
	/* -g option specified while compilation. */
	myMgr->debugLog("> WorkaroundTransient2_KBcancelable <onEntry>");
...
void WorkaroundTransient2_KBcancelable::onExit()
{
	/* -g option specified while compilation. */
	myMgr->debugLog("< WorkaroundTransient2_KBcancelable <onExit>");

}

void WorkaroundTransient2_KBcancelable::onMessage(const Mesg& mesg)
{
	if(mesg.message == CONT)
		onCONTMessage(mesg);
	else 
...
void WorkaroundTransient2_KBcancelable::onCONTMessage(const Mesg& mesg)
{
	int wParam = mesg.wParam;
	int lParam = mesg.lParam;
	ReceiverX& ctx = getMgr()->getCtx();
		...
		/* -g option specified while compilation. */
		myMgr->debugLog("WorkaroundTransient2_KBcancelable CONT <message trapped>");

	if(true)
	{
		/* -g option specified while compilation. */
		myMgr->debugLog("WorkaroundTransient2_KBcancelable CONT <executing exit>");

		const BaseState* root = getMgr()->executeExit("WorkaroundTransient2_KBcancelable", "BETWEEN_KBcancelable");
		/* -g option specified while compilation. */
		myMgr->debugLog("WorkaroundTransient2_KBcancelable CONT <executing effect>");
		...
		/* -g option specified while compilation. */
		myMgr->debugLog("WorkaroundTransient2_KBcancelable CONT <executing entry>");

		getMgr()->executeEntry(root, "BETWEEN_KBcancelable");
		return;
	}
...
//--------------------------------------------------------------------
WorkaroundTransient1_CompleteReceiverTopLevel::WorkaroundTransient1_CompleteReceiverTopLevel(const string& name, BaseState* parent, ReceiverSS* mgr)
 : ReceiverBaseState(name, parent, mgr)
{
	myHistory = false;
}

void WorkaroundTransient1_CompleteReceiverTopLevel::onEntry()
{
	/* -g option specified while compilation. */
	myMgr->debugLog("> WorkaroundTransient1_CompleteReceiverTopLevel <onEntry>");
...
void WorkaroundTransient1_CompleteReceiverTopLevel::onExit()
{
	/* -g option specified while compilation. */
	myMgr->debugLog("< WorkaroundTransient1_CompleteReceiverTopLevel <onExit>");

}

void WorkaroundTransient1_CompleteReceiverTopLevel::onMessage(const Mesg& mesg)
{
	if(mesg.message == CONT)
		onCONTMessage(mesg);
	else 
...
void WorkaroundTransient1_CompleteReceiverTopLevel::onCONTMessage(const Mesg& mesg)
{
	int wParam = mesg.wParam;
	int lParam = mesg.lParam;
	ReceiverX& ctx = getMgr()->getCtx();
		...
		/* -g option specified while compilation. */
		myMgr->debugLog("WorkaroundTransient1_CompleteReceiverTopLevel CONT <message trapped>");

	if(true)
	{
		/* -g option specified while compilation. */
		myMgr->debugLog("WorkaroundTransient1_CompleteReceiverTopLevel CONT <executing exit>");

		const BaseState* root = getMgr()->executeExit("WorkaroundTransient1_CompleteReceiverTopLevel", "KBcancelable_CompleteReceiverTopLevel");
		/* -g option specified while compilation. */
		myMgr->debugLog("WorkaroundTransient1_CompleteReceiverTopLevel CONT <executing effect>");
		...
		/* -g option specified while compilation. */
		myMgr->debugLog("WorkaroundTransient1_CompleteReceiverTopLevel CONT <executing entry>");
